sleep 30
wp core install --allow-root --path=/var/www/localhost/htdocs/ --url=MINIKUBE_IP:5050 --title=ft_services --admin_user=wp-admin --admin_password=wpwachtwoord --admin_email=novan-ve@student.codam.nl --skip-email
