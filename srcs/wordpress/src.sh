wp core install --allow-root --path=/www --url=MINIKUBE_IP:5050 --title=ft_services --admin_user=wp-admin --admin_password=wpwachtwoord --admin_email=novan-ve@student.codam.nl --skip-email
